...
transitBoardByLine.APP_ID 			= "tbdbylines";
...
transitBoardByLine.dependencies = [
		"/apps/assets/js/tracekit.js",
		"/apps/assets/js/libraries/fleegix.js",
		"/apps/assets/js/libraries/tzdate.js",
		"/apps/assets/js/libraries/jquery-ui-1.8.7.custom.min.js",	
		"/apps/assets/js/libraries/date.js",
		//"../assets/js/libraries/animation_frame.js",
		"/apps/assets/js/trArrUtilities.js",	
		"/apps/assets/js/trStopCache.js",
		"/apps/assets/js/trAgencyCache.js",
		"/apps/assets/js/trLoader.js",
		"/apps/assets/js/trArr.js",
		"/apps/assets/js/libraries/jquery.isotope.js",
		"/apps/assets/js/trCar2Go.js",
		"/apps/assets/js/trGBFS.js",
		"/apps/assets/js/trWeather.js"
];
