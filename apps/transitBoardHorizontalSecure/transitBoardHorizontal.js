...
transitBoardHorizontal.APP_ID 			= "tbdhorizontals";
...
/* use image pixels to track progress */
var img1 = document.createElement("IMG");
img1.src = "http://transitboard.com/nonexistant/hortizontalstart.jpg";
...
var app_url = "http://alt1.transitboard.com/apps/loaderSecure.html?"+primary_id;
...
if ( num_pages > 1 && appliance['id'] ) {
	for (var i=2;i<=num_pages;i++) {
		...
		var app_url2 = "http://alt1.transitboard.com/apps/loaderSecure.html?"+alt_id;
...
if ( second_page && appliance['id'] ) {
	var id = appliance['id'];
	var alt_id = id+":B";
	var app_url2 = "/apps/loaderSecure.html?"+alt_id;
